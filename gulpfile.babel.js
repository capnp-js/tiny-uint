...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-tiny-uint.js",
      format: "umd",
      name: "capnpJsTinyUint",
      sourcemap: true,
      globals: {},
    });
  });
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-tiny-uint.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-tiny-uint.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-tiny-uint.js.map",
            },
          }))
